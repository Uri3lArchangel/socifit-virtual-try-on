...
import { formatTime } from '@/src/FE/helpers';
...
if(state.type == 'success'){
  ...
  }, [state.time, notification,state.type]);
  ...
  return (
    ...
    className={`border-2  disabled:filter disabled:brightness-[0.8]  text-base text-[#DBD1F7] p-2 my-4 border-[#DBD1F7] rounded mb-3 block w-[100%] mx-auto sm:w-[200px]`}
  >
