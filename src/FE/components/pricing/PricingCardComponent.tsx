...
export function FreePricingCardComponent() {
  return (
    <Card className='max-w-[400px] w-full flex-col p-6 my-4'>
      ...
      <button
        type="button"
        className="inline-flex w-full justify-center rounded-lg bg-cyan-600 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-cyan-700 focus:outline-none focus:ring-4 focus:ring-cyan-200 dark:focus:ring-cyan-900 sm:text-lg"
      >
        Try for free
      </button>
    </Card>
...
export function PremiumPricingCardComponent() {
    return (
      <Card className='max-w-[400px] w-full flex-col p-6 my-4'>
        ...
        <ul className="my-7 space-y-5">
          ...
          <li className="flex space-x-3 line-through decoration-gray-500">
            ...
            <span className="text-base font-normal text-gray-500">24×7 phone & email support</span>
          </li>
        </ul>
        <button
          type="button"
...
export function CommercialPricingCardComponent() {
    return (
      <Card className='max-w-[400px] w-full flex-col p-6 my-4'>
        <h5 className="mb-4 text-xl font-medium text-gray-500 dark:text-gray-400">Commercial plan</h5>
        <div className="flex items-baseline text-gray-900 dark:text-white">
          <span className="text-3xl font-semibold">$</span>
        ...
        <ul className="my-7 space-y-5">
          ...
          <li className="flex space-x-3 line-through decoration-gray-500">
            ...
            <span className="text-base font-normal  text-gray-500">API Access</span>
          </li>
          <li className="flex space-x-3 line-through decoration-gray-500">
            <svg
              className="h-5 w-5 shrink-0 text-gray-400 dark:text-gray-500"
